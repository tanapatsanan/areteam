...
<head>
    ...
    <title>Portable Robot</title>
    <link rel="styles!heet" href="styles.css">
</head>
<body>
<?php include 'header.php';?>
    <div class="container">
        <h1 class="title">Portable Robot</h1>
        <div class="image-container">
            <img src="imgs/products1.png" alt="NOONAR robot illustration">
        </div>
        <h2 class="subtitle">Portable Robot is an Ultra-Light Throwable Robot Platform</h2>
            ...
            <div class="group">
                <div class="group">
                    <a href="#" class="image-box">
                        <img src="imgs/noonar1.JPG" alt="Homeland Security">
                        <div class="overlay-gradient"></div>
                        <div class="overlay-text">Homeland Security</div>
                    </a>
                    <a href="#" class="image-box">
                        <img src="imgs/noonar4.JPG" alt="Intelligence Gathering">
                        <div class="overlay-gradient"></div>
                        <div class="overlay-text">Intelligence Gathering</div>
                    </a>
                    <a href="#" class="image-box">
                        <img src="imgs/noonar5.JPG" alt="Special Forces">
                        <div class="overlay-gradient"></div>
        ...
        <div class="container3">
            ...
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                  ...
                  <img src="imgs/002.png" width="350" height="350">
                  <div class="text">REMOTE  D.4</div>
                </div>
                
                <div class="mySlides fade">
                  <div class="numbertext"></div>
                  <img src="imgs/001.png" width="320" height="350">
        ...
        <div class="container4">
            ...
            <div class="gallery-container">
                <div class="main-image">
                    <img id="currentImage" src="imgs/noonar1.JPG" alt="Main Image">
                </div>
                <div class="thumbnail-container">
                    <img class="thumbnail" src="imgs/noonar1.JPG" alt="Thumbnail 1" onclick="changeImage('imgs/noonar1.JPG')">
                    <img class="thumbnail" src="imgs/noonar5.JPG" alt="Thumbnail 2" onclick="changeImage('imgs/noonar5.JPG')">
                    <img class="thumbnail" src="imgs/noonar4.JPG" alt="Thumbnail 3" onclick="changeImage('imgs/noonar4.JPG')">
                    <img class="thumbnail" src="imgs/noonar2.png" alt="Thumbnail 4" onclick="changeImage('imgs/noonar2.png')">
                    <img class="thumbnail" src="imgs/noonar3.png" alt="Thumbnail 5" onclick="changeImage('imgs/noonar3.png')">
                </div>
