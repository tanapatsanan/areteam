...
<?php include 'header.php';?>
    <div class="container">
        ...
        <div class="image-container">
            <img src="imgs/001.png" alt="NOONAR robot illustration">
        </div>
        <h2 class="subtitle">REMOTE is an Ultra-Light Throwable Robot Platform</h2>
            ...
            <div class="group">
                <div class="group">
                    <a href="#" class="image-box">
                        <img src="imgs/remote1.jpg" alt="Homeland Security">
                        <div class="overlay-gradient"></div>
                        <div class="overlay-text">Homeland Security</div>
                    </a>
                    <a href="#" class="image-box">
                        <img src="imgs/remote3.jpg" alt="Intelligence Gathering">
                        <div class="overlay-gradient"></div>
                        <div class="overlay-text">Intelligence Gathering</div>
                    </a>
                    <a href="#" class="image-box">
                        <img src="imgs/remote5.jpg" alt="Special Forces">
                        <div class="overlay-gradient"></div>
        ...
        <div class="container3">
            ...
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                  ...
                  <img src="imgs/products1.png" width="350" height="350">
                  <div class="text">Noonar</div>
                </div>
                
                <div class="mySlides fade">
                  <div class="numbertext"></div>
                  <img src="imgs/products2.png" width="320" height="350">
                  <div class="text">D-Empir</div>
                </div>
        ...
        <div class="container4">
            ...
            <div class="gallery-container">
                <div class="main-image">
                    <img id="currentImage" src="imgs/remote1.jpg" alt="Main Image">
                </div>
                <div class="thumbnail-container">
                    <img class="thumbnail" src="imgs/remote1.jpg" alt="Thumbnail 1" onclick="changeImage('imgs/remote1.jpg')">
                    <img class="thumbnail" src="imgs/remote3.jpg" alt="Thumbnail 2" onclick="changeImage('imgs/remote3.jpg')">
                    <img class="thumbnail" src="imgs/remote5.jpg" alt="Thumbnail 3" onclick="changeImage('imgs/remote5.jpg')">
                    <img class="thumbnail" src="imgs/remote2.jpg" alt="Thumbnail 4" onclick="changeImage('imgs/remote2.jpg')">
                    <img class="thumbnail" src="imgs/remote4.jpg" alt="Thumbnail 5" onclick="changeImage('imgs/remote4.jpg')">
                </div>
